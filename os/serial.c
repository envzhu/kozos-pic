...
#define IPC8SET *((volatile unsigned int *)0xBF881118)
#define IPC9    *((volatile unsigned int *)0xBF881120)
#define IPC9CLR *((volatile unsigned int *)0xBF881124)
#define IPC9SET *((volatile unsigned int *)0xBF881128)
...
{
  if(index==0)
    IEC1SET=PIC_UART1_SEND_INTTERUPT_FLAG;
  
  if(index==1)
    IEC1SET=PIC_UART2_SEND_INTTERUPT_FLAG;
...
{
  if(index==0)
    IEC1CLR=PIC_UART1_SEND_INTTERUPT_FLAG;
...
{
  if(index==0)
    IEC1SET=PIC_UART1_RECV_INTTERUPT_FLAG;
  
  if(index==1)
    IEC1SET=PIC_UART2_RECV_INTTERUPT_FLAG;
...
{
  if(index==0)
    IEC1CLR=PIC_UART1_RECV_INTTERUPT_FLAG;
  
  if(index==1)
    IEC1CLR=PIC_UART2_RECV_INTTERUPT_FLAG;
