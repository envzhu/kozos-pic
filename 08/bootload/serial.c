...
{
  volatile unsigned int *U2STA=0xBF806210;
  volatile unsigned int *U2TXREG=0xBF806220;
  volatile unsigned int *U2BRG=0xBF806240;
  volatile unsigned int *U2MODE=0xBF806200;
  ...
  volatile unsigned int *IEC0SET=0xBF881068;
  *U2STA = 0x0;
  *U2TXREG = 0x0;
  *U2BRG = 0x137;//????????
  ...
  *IEC0SET=0b110;
  ...
  //*IEC1SET=0x400000;    //IEC1bits.U2RXIE = 1;
  *U2MODE = 0x8000;//UART ??
return 0;
}
...
{
  volatile unsigned int *U2RXREG=0xBF806230;
  volatile struct pic_sci *sci = regs[index].sci;
  unsigned char c;
